var myMultiMap = function(obj){
    ...
    this.renderEchart = function(addData){
        ...
        // url = 'https://github.com/yukiluoyun/dirll_echart/blob/master/json/listJsonlevel1areaCode360100.json';--真正
        url = 'https://github.com/yukiluoyun/dirll_echart/blob/master/json/listJsonlevel1areaCode360100.json';
        if(_breadcrumb){
